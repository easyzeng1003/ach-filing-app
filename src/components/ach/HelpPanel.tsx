    ...
    <div className="space-y-4">
      <div className="card p-5">
        ...
        <p className="text-sm leading-relaxed text-muted">
          ...
          亦可直接「大檔轉 R01／轉回 P01」。多檔下載會打包 ZIP 或選一次資料夾。
      ...
      <div className="card p-5">
        ...
        <ol className="list-decimal space-y-1 pl-5 text-sm text-muted">
          ...
          <li>套用後檢核錯誤、修正資料（小檔）；或按「編輯」分割後逐包修改／大檔轉 R01（或轉回 P01）</li>
...
// 3. 重新載入即可使用`}
      ...
      <div className="card p-5">
        ...
        <p className="mb-2 text-sm text-muted">
          ...
          每個明細列第 108–115 碼（PSEQ）維持上傳檔原值，不改抄 SEQ。
          上傳 R01 依檔案原樣解析，不先對調 P／R。
          上傳 P01 時提示行／發動者＝提出行（PBANK／PCLNO），收受者＝RBANK／RCLNO，不對調。
          來源為提回檔時，輸出 P01 再對調回提出檔。
          「包含」只要欄位值含輸入字串即命中（類似{" "}
